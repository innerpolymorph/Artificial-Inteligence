...
<<<<<<< HEAD
    ...
    for column in range(0, M):
	    if (board[N-2][column] == 'O'):
		    if (board[N-1][column] == '_'):
			    isolated_pegs += 1
=======
    ...
    # Columns
    M = len(board[0])    
>>>>>>> 183d44b415c88d5389dfc2e22bdfb699aa9e7dce
...
def max_moves(node):
        ...
        return node.state.number_of_pieces - 1 - (pegs_with_move / node.state.number_of_pieces)
...
<<<<<<< HEAD
    	...
    	return isolated_pegs(node.state)
=======
        return (isolated_pegs(node) - 1) * max_moves(node)
>>>>>>> 183d44b415c88d5389dfc2e22bdfb699aa9e7dce
